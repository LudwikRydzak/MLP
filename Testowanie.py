...
class Testowanie:
    def __init__(self):
        ...
        self.batch_sizes = [1,2,4,8,10,16,20,30,32,40,50,60,64,70,80,90,100,128,200,256,300,400,512,700,1024,1500,2048]
    ...
    def test_batch_size(self, train_set, train_labels, test_set, test_labels):
        with open('badania_batch_size.txt', 'w') as file:
            ...
            self.show_batch_size_procent(self.hidden_layer_sizes,self.x_procenty)
            self.show_batch_size_epoki(self.hidden_layer_sizes,self.x_epoki)
    ...
    def test_learning_factor(self, learning_factor):
